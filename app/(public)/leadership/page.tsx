...
const LeaderCard = ({ leader, delay, onSelect }: { leader: any, delay: number, onSelect: (leader: any) => void }) => {
  ...
  const imageSrc = !imgError && leader.photo ? leader.photo : '/images/hamza-rehman.jpg';
